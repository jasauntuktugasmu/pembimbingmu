...
const NotFound = () => {
  ...
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "Halaman Not Found - Pembimbingmu",
    "description": "Halaman yang Anda cari tidak ditemukan. Kembali ke beranda Pembimbingmu untuk mengakses layanan bimbingan skripsi."
  };
